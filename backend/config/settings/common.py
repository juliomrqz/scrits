# -*- coding: utf-8 -*-
"""
Django settings for Scrits project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (scrits/config/settings/common.py - 3 = scrits/)
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'scrits.contrib.sites.migrations'
}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///scrits'),
}
...
ACCOUNT_ADAPTER = 'scrits.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'scrits.users.adapters.SocialAccountAdapter'
...
WEBPACK_LOADER = {
    'DEFAULT': {
        ...
        'STATS_FILE': str(ANGULAR_DIR.path('webpack-stats.json')),
    }
}
